...
```
implementation 'io.github.q3769:conseq4j:20220715.0.0'
```
...
to ensure proper access order among the concurrent caller threads. e.g. This can be as trivial as setting up
