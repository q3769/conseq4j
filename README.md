...
, to establish a certain sequence of task submissions, and leave it to the conseq4j API to do the job of providing
concurrency, as well as proper sequencing, while executing the submitted tasks.
