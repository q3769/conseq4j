...
2. As a client of this Java concurrent API, I want to submit a task for execution together with a sequence key, so that,
   across multiple such submissions, all related tasks under the same/equal sequence key are executed sequentially and
...
```
implementation 'io.github.q3769:conseq4j:20220714.0.0'
```
