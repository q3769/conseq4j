...
, to establish a certain sequence of task submissions, and let the conseq4j API do its job of providing concurrency, as
well as proper sequencing, while executing the submitted tasks.
