...
What now then, going back to Setup 1? Well, you can do that, at the expense of limitting performance. Or, you could use a "conseq" instead (and save your beer), as in Setup 3:
