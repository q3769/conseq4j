...
```
implementation 'io.github.q3769:conseq4j:20220727.0.7'
```
...
multithreading client to establish a definitive submission order as Java does not provide a strong guarantee on thread
