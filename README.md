...
- That is all well and good, but processing all messages in sequential order globally is a bit slow, isn't it? It's overly conservative, to say the least, when running on a multiprocessing infrastructure.
