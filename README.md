...
public class MessageConsumer {
    ...
    ...
```
As it turned out, with Setup 2, the shopper actually received a T-Shirt of size Large instead of the Medium that s/he so painstakingly settled on (got real mad and knocked over your beer). And you wonder why that happened... Oh, got it, the shot-gun threads processed the 10 events out of order!
